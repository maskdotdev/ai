    ...
    typography: ({ theme }) => ({
      ...
      DEFAULT: {
        css: {
          ...
          '--tw-prose-underline-hover': theme('colors.zinc.700'),
          ...
          '--tw-prose-invert-underline': theme('colors.neutral.600'),
          '--tw-prose-invert-underline-hover': theme('colors.neutral.400'),
          ...
          '--tw-prose-invert-pre-border': theme('colors.neutral.800'),
